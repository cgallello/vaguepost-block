...
- Added local Chrome Prompt API/Gemini Nano classification with bounded queues, caching, constrained output, and fail-closed unavailable-model behavior.
- Added Review-only, Blur & Review, and acknowledged Automatic block modes.
